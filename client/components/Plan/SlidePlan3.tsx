  ...
  return (
    <>
      ...
      <Slider className="slide  aboutslide" ref={slide => setNav1(slide)} {...settings}>
          <img src="/assets/img/plans/3/1.png" alt="middle slider" /> 
          <img src="/assets/img/plans/3/2.png" alt="middle slider" />
