        ...
        <>
            <Head>
                ...
                <script src="//code-ya.jivosite.com/widget/xhQVlWMolS" async/>
								<title>ЖК Солнечный парк: квартиры в новостройке в Симферополе | Продажа от застройщика</title>
				        <meta name="keywords" content="новостройки Симферополя, квартиры от застройщика, жк в Симферополе, купить квартиру, недвижимость Симферополя, купить жилье" />
								<meta name="description" content='Продажа квартир в новостройках жилого комплекса "Солнечный парк" от застройщика ООО СЗ "СК "Аркада Крым". Доступна ипотека на весь срок кредитования и беспроцентная рассрочка от застройщика. ЖК "Солнечный парк" – это передовые технологии монолитного строительства, уникальные дизайнерские планировки квартир, адаптивное освещение. ЖК "Солнечный парк" расположен в Симферополе, рядом с ПГТ Молодежное. Удобная транспортная доступность и развитая инфраструктура – рядом Московское шоссе, в нескольких минутах езды крупные ТРЦ "Меганом" и "Южная галерея". Телефон отдела продаж +7 (978) 718-08-08.' />
            ...
            <div className="genplan__features">
                {
                    ...
                    <div className='genplan_modal'>
                        ...
                        <div className='genplan_modal_text'>Приобретая жилье в жилом комплексе «Солнечный Парк», вы
                            можете воспользоваться ипотечными программами от наших банков-партнеров:
                        </div>
                ...
                }
                {
                    ...
                    <div className='genplan_modal genplan_modal_small'>
                        ...
                        <div className='genplan_modal_bank'>
                            <a target="_blank" href='https://disk.yandex.ru/d/5MCvNtWhxRo0ew'><img
                                src='/assets/img/dom1.png'/></a>
                            <a target="_blank" href='https://disk.yandex.ru/d/89S31HqpRiSA9g'><img
                                src='/assets/img/dom2.png'/></a>
                        </div>
                    </div>
                }
                    ...
                    <div className="row gap-5 w-100 mx-auto genplan__features--box">
                        ...
                        <div className="genplan__item col-md col-12" onClick={() => setIsExcursionModalOpen(true)}>
                            <svg width="21" height="20" viewBox="0 0 21 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M20.0032 16.9158L16.023 12.9355L18.8626 11.2954C19.0844 11.1672 19.2135 10.9236 19.1951 10.6681C19.1766 10.4125 19.0138 10.1899 18.7758 10.095L6.1138 5.04411C5.86558 4.94498 5.58215 5.00337 5.39312 5.19232C5.2041 5.38141 5.14572 5.66478 5.24477 5.913L10.2949 18.5765C10.3898 18.8145 10.6124 18.9774 10.868 18.9958C11.1236 19.0144 11.3673 18.8853 11.4953 18.6633L13.1353 15.8238L17.1152 19.804C17.2406 19.9295 17.4108 20 17.5881 20C17.7656 20 17.9357 19.9295 18.0611 19.804L20.0032 17.8616C20.2644 17.6004 20.2644 17.177 20.0032 16.9158Z"
                                    fill="#D5D5D5"/>
                                <path
                                    d="M3.13669 1.99003C2.87548 1.72902 2.45211 1.72896 2.19077 1.99003C1.92962 2.25125 1.92962 2.67475 2.19077 2.93596L3.67689 4.42209C3.80747 4.55266 3.97858 4.61798 4.14982 4.61798C4.32093 4.61798 4.49211 4.55266 4.62268 4.42209C4.8839 4.16088 4.8839 3.73744 4.62268 3.47623L3.13669 1.99003Z"
                                    fill="#D5D5D5"/>
                                <path
                                    d="M3.64033 6.6138C3.64033 6.24451 3.34087 5.94498 2.97144 5.94498H0.869756C0.500395 5.94498 0.200867 6.24444 0.200867 6.6138C0.200867 6.98316 0.500328 7.28269 0.869756 7.28269H2.97144C3.34087 7.28263 3.64033 6.98316 3.64033 6.6138Z"
                                    fill="#D5D5D5"/>
                                <path
                                    d="M3.36922 8.67805L1.88289 10.1643C1.62174 10.4255 1.62174 10.849 1.88289 11.1102C2.01353 11.2407 2.18471 11.3061 2.35582 11.3061C2.52693 11.3061 2.69817 11.2407 2.82875 11.1102L4.31501 9.62397C4.57622 9.36276 4.57622 8.93926 4.31501 8.67805C4.05386 8.41704 3.63056 8.41697 3.36922 8.67805Z"
                                    fill="#D5D5D5"/>
                                <path
                                    d="M6.81427 3.4396C7.18363 3.4396 7.48316 3.14013 7.48316 2.77071V0.668822C7.48316 0.299461 7.1837 0 6.81427 0C6.44497 0 6.14545 0.299394 6.14545 0.668822V2.77077C6.14545 3.14013 6.44491 3.4396 6.81427 3.4396Z"
                                    fill="#D5D5D5"/>
                                <path
                                    d="M9.3511 4.31017C9.52235 4.31017 9.69346 4.24485 9.82403 4.11428L11.3101 2.62815C11.5713 2.36694 11.5713 1.94343 11.3101 1.68222C11.0489 1.42114 10.6254 1.42114 10.3642 1.68222L8.87817 3.16842C8.61696 3.42963 8.61696 3.85313 8.87817 4.11428C9.00881 4.24485 9.17992 4.31017 9.3511 4.31017Z"
                                    fill="#D5D5D5"/>
                            </svg>
                                            ...
                                            <section>
                                                ...
                                                <div className='modal_header_info'>
                                                    <p>Обращаем ваше внимание, что режим работы службы поддержки:
                                                        <div className='modal_header-time'> с ПН по ПТ — 9:30 - 18:00,
                                                            СБ — 10:00 - 14:00.</div>
                                                        <div className='modal_header-gren'>ВС — выходной</div>
                                                    </p>
                                                </div>
                                            </section>
