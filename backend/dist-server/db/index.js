...
var connection = _mongoose["default"].connect("mongodb://".concat(DB_URL, "/").concat(DB_NAME), mongooseOptions); //const conectalias = mongoose.connect(alias, mongooseOptions2);
